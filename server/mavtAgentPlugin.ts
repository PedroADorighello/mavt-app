...
async function callOpenAIResponses(apiKey: string, options: MavtAgentPluginOptions, payload: unknown) {
...
async function callCompatibleChat(apiKey: string, options: MavtAgentPluginOptions, payload: unknown) {
